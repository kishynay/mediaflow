...
async function connectDB() {
  try {
    ...
    const bucketName = process.env.GRIDFS_BUCKET || process.env.GRIDFS_BUCKET_NAME || "uploads";
    ...
    const activeDbName = mongoose.connection?.db?.databaseName || mongoose.connection?.name || dbName;
